...
public class MultiArrayDemo1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("scores3的元素有: " + scores3.length);
		System.out.println(scores3); //二維陣列
		System.out.println(scores3[0] + "," + scores3[0].length);
		System.out.println(scores3[1] + "," + scores3[1].length);
		
		//將每一筆資料印出
		System.out.println("scores3[0][0] = " + scores3[0][0]);
		System.out.println("scores3[0][1] = " + scores3[0][1]);
		System.out.println("scores3[0][20] = " + scores3[0][2]);
		...
		for (int i = 0; i < scores3.length; i++) {
            for (int j = 0; j < scores3[i].length; j++) {
                System.out.println("scores3[" + i + "][" + j + "] = " + scores3[i][j]);
            }
        }
	}
